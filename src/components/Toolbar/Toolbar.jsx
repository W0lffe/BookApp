        ...
        <div className="flex flex-col w-full h-fit gap-2 px-5 lg:items-center font-medium">
            ...
            <section className="flex flex-col w-full items-center justify-center gap-2 ">
                <button onClick={handleAdd}
                        className="w-40 p-2 border-1 border-black rounded-bl-[12px] rounded-tr-[12px] hover:p-3 bg-gradient-to-tr from-gray-800/60 to-gray-600/80 hover:bg-gray-400/50 hover:animate-pulse transition-all">
                ADD BOOK</button>
                <Sort />
            </section>
        </div>
